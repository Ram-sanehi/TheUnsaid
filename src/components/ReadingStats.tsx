...
export function ReadingStats({ onClose }: ReadingStatsProps) {
    ...
    useEffect(() => {
        ...
        const lastHighlight = highlights.length > 0
            ? highlights[highlights.length - 1].text?.slice(0, 80) || ''
            : '';
    ...
    return (
        <div className="sticky-note-modal-overlay" onClick={(e) => {
            ...
            <div style={{
                ...
                <div className="stats-grid">
                    <div className="stat-item">
                        <div className="stat-value">{stats.pagesRead}/{stats.totalPages}</div>
                        <div className="stat-label">Chapters Read</div>
                    </div>
                    <div className="stat-item">
                        <div className="stat-value">{stats.timeRemaining}<span style={{ fontSize: '0.6em' }}>m</span></div>
                ...
                {stats.lastHighlight && (
                    <div style={{
                        ...
                        <p style={{
                            ...
                            "{stats.lastHighlight}{stats.lastHighlight.length >= 80 ? '…' : ''}"
                        </p>
                    </div>
                )}
            </div>
